...
namespace FlightSim
{
    ...
    public class SerializerHelper
    {
        ...
        public static object FromJson(string jsondata, Type objectType)
        {
            ...
            var obj = JsonConvert.DeserializeObject(jsondata, objectType, jset);
        ...
        public static object FromXml(string xmldata, Type objectType)
        {
            ...
            if (serializer != null)
            {
                ...
                object? obj = serializer.Deserialize(loginDataString);
                if (obj != null)
                {
                    return obj;
                }
    ...
    public class CustomEnumConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var enumText = reader.Value != null ? reader.Value.ToString() : null!;
