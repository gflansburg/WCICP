...
namespace FlightSim.DCS_BIOS.Misc
{
    /// <summary>
    ...
    internal class LuaAssistant
    {
        ...
        private static string _dcsbiosAircraftLuaLocation = null!;
        private static string _dcsbiosCommonModulesLuaLocation = null!;
        private static string _dcsbiosModuleLuaFilePath = null!;
