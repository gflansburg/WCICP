...
namespace FlightSim
{
    public class AircraftData
    {
        ...
        public string ATCModel { get; set; } = null!;
        public string ATCType { get; set; } = null!;
        public string ATCIdentifier { get; set; } = null!;
        public string Name { get; set; } = null!;
        public EngineType EngineType { get; set; }
        public bool Heavy { get; set; }
        public bool Helo { get; set; }
        public LatLong Position { get; set; } = null!;
        ...
        public string FriendlyType { get; set; } = null!;
        public string FriendlyModel { get; set; } = null!;
        ...
        {
            AircraftData data = Tools.LoadAircraft(flightData.ATC_TYPE, flightData.ATC_MODEL);
            if (data == null)
            {
            ...
            Position = new LatLong(flightData.PLANE_LATITUDE, flightData.PLANE_LONGITUDE);
            ...
            FuelRemaining = flightData.FUEL_TOTAL_REMAINING_GAL;
            FuelCapacity = flightData.FUEL_CAPACITY_GAL;
